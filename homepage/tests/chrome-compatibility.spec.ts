 ...
 * properly in Google Chrome (Chromium). They cover:
...
test.describe('Cross-Browser Compatibility - Chrome', () => {
  ...
  test.describe('TC1: Page Rendering in Chrome', () => {
  ...
  test.describe('TC2: Navigation Links in Chrome', () => {
  ...
  test.describe('TC3: Copy-to-Clipboard in Chrome', () => {
    ...
    test('Clipboard API is supported in Chrome', async ({ page }) => {
