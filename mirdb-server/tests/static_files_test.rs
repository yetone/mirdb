...
#[test]
fn test_homepage_returns_html_with_mirdb_branding() {
    run_async(async {
...
#[test]
fn test_css_served_with_correct_headers() {
    run_async(async {
        let app = create_router();
...
#[test]
fn test_javascript_served_with_correct_headers() {
    run_async(async {
        let app = create_router();
...
#[test]
fn test_homepage_load_performance() {
    run_async(async {
...
#[test]
fn test_all_referenced_assets_available() {
    run_async(async {
        let app = create_router();
