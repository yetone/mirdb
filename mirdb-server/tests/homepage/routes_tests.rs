//! Route Tests for Homepage Static Content
//!
...
//! - Header with logo/name and theme toggle
//! - Features section with Memcached, LSM tree, and persistence descriptions
//! - Quick start section with CLI examples
...
// ============================================================================
// Test Case 1: Response returns HTML with correct content type
// ============================================================================
...
#[test]
fn test_header_contains_theme_toggle() {
    assert!(
    ...
    assert!(
        ...
        "Theme toggle must have id for JavaScript"
    );
}

#[test]
fn test_header_section_exists() {
    assert!(
...
#[test]
fn test_features_memcached_protocol() {
...
#[test]
fn test_features_has_three_cards() {
...
#[test]
fn test_quick_start_section_exists() {
    assert!(
...
#[test]
fn test_quick_start_contains_code_examples() {
    assert!(
...
#[test]
fn test_quick_start_contains_set_command() {
    assert!(
...
#[test]
fn test_quick_start_contains_get_command() {
    assert!(
...
#[test]
fn test_quick_start_contains_telnet_example() {
    assert!(
        INDEX_HTML.contains("telnet"),
        "Quick start must contain telnet connection example"
    );
}
...
#[test]
fn test_footer_contains_documentation_link() {
    let html_lower = INDEX_HTML.to_lowercase();
    assert!(
