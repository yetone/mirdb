...
/// Test module for status API
mod status_api_tests {
    use super::*;

    // Import the status handler module
    // Note: This test file tests the status module functionality directly
    // since we don't have a running HTTP server in unit tests

    /// Test 1: StatusResponse contains all required fields
    #[test]
    fn test_status_response_has_required_fields() {
        // Read the status.rs file to verify it contains required fields
        let status_rs = std::fs::read_to_string("src/http/handlers/status.rs")
    ...
    fn test_response_time_measurement() {
        ...
        let _content = std::fs::read_to_string("src/http/handlers/status.rs")
            .expect("Failed to read status.rs");
...
/// Test module for status JavaScript integration
mod status_js_tests {
    use super::*;

    /// Test 1: status.js file exists
    #[test]
    ...
    /// Test 2: status.js exports required functions
    #[test]
    fn test_status_js_exports() {
        let status_js = std::fs::read_to_string("src/web/scripts/status.js")
    ...
    /// Test 3: Auto-refresh interval is 5 seconds
    #[test]
    ...
    /// Test 4: status.js uses MirDBApi for fetching
    #[test]
    ...
    /// Test 5: status.js renders metrics grid
    #[test]
    ...
    /// Test 6: status.js shows refresh indicator
    #[test]
...
mod status_html_tests {
    use super::*;

    /// Test 1: index.html has status section
    #[test]
    ...
    /// Test 2: Status panel element exists
    #[test]
    ...
    /// Test 3: status.js is included in HTML
    #[test]
