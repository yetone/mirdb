//! Key Get API Tests - Scenario 6
//! Owner: Scenario 6 - Key Operations - Get Key
//!
//! Tests:
...
// ============================================
// Test Case 1: GET /api/keys/{key} returns JSON with value, flags, ttl, size
// ============================================
...
// ============================================
// Test Case 3: Modal displays value with copy button functional
// ============================================
