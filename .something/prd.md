...
**As a** potential user
**I want to** learn about the key features of the URL shortening service
...
**So that** I can visualize the user experience before committing
...
**So that** I can sign into my existing account
...
**So that** I can view the content in my preferred visual style
...
**As a** mobile user
**I want to** view the homepage correctly on my smartphone
**So that** I can learn about the service on any device
