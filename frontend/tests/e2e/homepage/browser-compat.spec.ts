...
/**
 * Scenario 23: Browser Compatibility - Edge
 *
 * Tests that the homepage works correctly in Microsoft Edge browser.
 * Verifies all sections render correctly with proper styling and
 * all links and buttons function correctly.
 */
test.describe('Browser Compatibility - Edge @msedge', () => {
  test.describe('Test Case 1: Load homepage in Edge - All sections render correctly with proper styling', () => {
    test('should render hero section with proper styling in Edge', async ({ page }) => {
      await page.goto('/');
      await waitForHeroSection(page);
    ...
    test('should render features section with all feature cards in Edge', async ({ page }) => {
      await page.goto('/');
      await waitForHeroSection(page);
    ...
    test('should render how-it-works section with all steps in Edge', async ({ page }) => {
      await page.goto('/');
      await waitForHeroSection(page);
    ...
    test('should render dashboard preview section in Edge', async ({ page }) => {
      await page.goto('/');
      await waitForHeroSection(page);
    ...
    test('should render footer section with copyright in Edge', async ({ page }) => {
      await page.goto('/');
      await waitForHeroSection(page);
    ...
    test('should render navbar with all elements in Edge', async ({ page }) => {
      await page.goto('/');
      await waitForHeroSection(page);

      // Verify main navbar is visible
      const navbar = page.locator('nav.navbar');
      await expect(navbar).toBeVisible();
    ...
    test('should apply correct CSS styles and layout in Edge', async ({ page }) => {
      await page.goto('/');
      await waitForHeroSection(page);
      ...
      // Verify main content area has proper structure
      const main = page.locator('main');
      await expect(main).toBeVisible();
  ...
  test.describe('Test Case 2: Test navigation and CTAs in Edge - All links and buttons function correctly', () => {
    test('should navigate to registration page when clicking Get Started CTA in Edge', async ({
      page,
    }) => {
      await page.goto('/');
      await waitForHeroSection(page);
    ...
    test('should navigate to login page when clicking login link in hero in Edge', async ({
      page,
    }) => {
      await page.goto('/');
      await waitForHeroSection(page);
    ...
    test('should navigate to login page when clicking navbar login button in Edge', async ({
      page,
    }) => {
      await page.goto('/');
      await waitForHeroSection(page);
    ...
    test('should navigate to registration page when clicking navbar register button in Edge', async ({
      page,
    }) => {
      await page.goto('/');
      await waitForHeroSection(page);
    ...
    test('should toggle theme when clicking theme toggle button in Edge', async ({ page }) => {
      await page.goto('/');
      await page.evaluate(() => {
        localStorage.setItem('theme', 'light');
      });
    ...
    test('should have working dashboard preview CTA button in Edge', async ({ page }) => {
      await page.goto('/');
      await waitForHeroSection(page);
    ...
    test('should have keyboard-accessible navigation in Edge', async ({ page }) => {
      await page.goto('/');
      await waitForHeroSection(page);
    ...
    test('should handle scroll behavior correctly in Edge', async ({ page }) => {
      await page.goto('/');
      await waitForHeroSection(page);
    ...
    test('should maintain functionality after theme toggle in Edge', async ({ page }) => {
      await page.goto('/');
      await page.evaluate(() => {
        localStorage.setItem('theme', 'light');
      });
    ...
    test('should display all content without layout issues in Edge', async ({ page }) => {
      await page.goto('/');
      await waitForHeroSection(page);
  ...
  test.describe('Additional Edge-specific tests', () => {
    test('should not have any console errors on page load in Edge', async ({ page }) => {
      const consoleErrors: string[] = [];
      page.on('console', (msg) => {
        if (msg.type() === 'error') {
          consoleErrors.push(msg.text());
    ...
    test('should render images without errors in Edge', async ({ page }) => {
      await page.goto('/');
      await waitForHeroSection(page);
    ...
    test('should have proper viewport meta tag for Edge', async ({ page }) => {
      await page.goto('/');
    ...
    test('should support CSS Grid and Flexbox layouts in Edge', async ({ page }) => {
      await page.goto('/');
      await waitForHeroSection(page);
    ...
    test('should correctly render Framer Motion animations in Edge', async ({ page }) => {
      await page.goto('/');
      await waitForHeroSection(page);
    ...
    test('should support modern CSS features in Edge', async ({ page }) => {
      await page.goto('/');
      await waitForHeroSection(page);
      ...
      // Edge supports backdrop-filter
      expect(supportsBackdropFilter).toBe(true);
    });

    test('should maintain proper z-index stacking in Edge', async ({ page }) => {
      await page.goto('/');
      await waitForHeroSection(page);
    ...
    test('should persist theme preference across page reloads in Edge', async ({ page }) => {
      await page.goto('/');
      await page.evaluate(() => {
        localStorage.setItem('theme', 'light');
      });
    ...
    test('should show correct toggle icon based on current theme in Edge', async ({ page }) => {
      // Start with light theme
      await page.goto('/');
      await page.evaluate(() => {
        localStorage.setItem('theme', 'light');
