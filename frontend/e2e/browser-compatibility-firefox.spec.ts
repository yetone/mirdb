...
/**
 * Browser Compatibility - Firefox Tests (NFR-6)
 *
 * These tests verify that the homepage functions correctly on Firefox browser
 ...
 *
 * This test file specifically targets Firefox browser compatibility.
 */
...
test.describe('Browser Compatibility - Firefox', () => {
  ...
  test.describe('Test Case 1: Homepage Rendering in Firefox', () => {
    ...
    test('CSS flexbox and grid layouts render correctly in Firefox', async ({ page }) => {
      await page.goto('/');
    ...
    test('CSS custom properties (variables) are applied in Firefox', async ({ page }) => {
      await page.goto('/');
  ...
  test.describe('Test Case 2: Navigation Links in Firefox', () => {
  ...
  test.describe('Test Case 3: Interactive Elements in Firefox', () => {
    ...
    test('mobile menu toggle button works in Firefox', async ({ page }) => {
    ...
    test('interactive elements have hover states in Firefox', async ({ page }) => {
      await page.goto('/');
    ...
    test('navigation links have focus states in Firefox', async ({ page }) => {
      await page.goto('/');
    ...
    test('forms and buttons submit correctly in Firefox (if present)', async ({ page }) => {
      await page.goto('/');
    ...
    test('keyboard navigation works for interactive elements in Firefox', async ({ page }) => {
      await page.goto('/');
    ...
    test('social links in footer open correctly in Firefox', async ({ page }) => {
      await page.goto('/');
  ...
  test.describe('Firefox-Specific Rendering Checks', () => {
    test('viewport meta tag is respected in Firefox', async ({ page }) => {
      await page.goto('/');
    ...
    test('page does not have horizontal scroll on desktop in Firefox', async ({ page }) => {
    ...
    test('page does not have horizontal scroll on mobile in Firefox', async ({ page }) => {
      await page.setViewportSize({ width: 375, height: 667 });
      await page.goto('/');
    ...
    test('JavaScript executes correctly in Firefox', async ({ page }) => {
      await page.goto('/');
    ...
    test('CSS transitions work in Firefox', async ({ page }) => {
      await page.goto('/');

      // Verify CSS transitions are supported
      const ctaButton = page.locator('[data-testid="hero-cta"]');
      const transitionValue = await ctaButton.evaluate((el) => {
        return window.getComputedStyle(el).transition;
      });

      // Firefox should support CSS transitions
      expect(transitionValue).toBeDefined();
    });

    test('Firefox handles custom fonts correctly', async ({ page }) => {
      await page.goto('/');
