...
test.describe('Cross-Browser Compatibility - Edge', () => {
  ...
  test('TC1: Page loads without console errors in Edge', async ({ page }) => {
  ...
  test('TC2: All sections display with correct layout in Edge', async ({ page }) => {
  ...
  test('TC3: Smooth scroll navigation works in Edge', async ({ page }) => {
  ...
  test('CSS custom properties (variables) work correctly in Edge', async ({ page }) => {
  ...
  test('SVG diagram renders correctly in Edge', async ({ page }) => {
  ...
  test('External links have correct attributes in Edge', async ({ page }) => {
  ...
  test('Fixed navigation stays at top when scrolling in Edge', async ({ page }) => {
  ...
  test('Code blocks render with syntax highlighting in Edge', async ({ page }) => {
